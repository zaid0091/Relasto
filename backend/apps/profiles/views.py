...
class ProfileViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"status": "success", "data": {"profile": serializer.data}},
                status=status.HTTP_200_OK,
            )
        except Exception as e:
            return Response(
                {"status": "error", "error": str(e), "code": "PROFILE_ERROR"},
    ...
    def update(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"status": "error", "error": str(e), "code": "PROFILE_UPDATE_ERROR"},
                status=status.HTTP_400_BAD_REQUEST,
            )
            ...
            if "min_rating" in request.query_params:
                try:
                    filters["min_rating"] = float(
                        request.query_params.get("min_rating")
                    )
                except ValueError:
                    pass
    ...
    def properties(self, request, pk=None):
        ...
        try:
            ...
            properties = ProfileService.get_agent_properties(
                profile.user_id, status_filter
            )
            ...
            return Response(
                {"status": "success", "data": {"properties": serializer.data}},
                status=status.HTTP_200_OK,
            )
        except Exception as e:
            return Response(
                {"status": "error", "error": str(e), "code": "PROPERTIES_ERROR"},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def reviews(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"status": "success", "data": {"reviews": serializer.data}},
                status=status.HTTP_200_OK,
            )
        except Exception as e:
            return Response(
                {"status": "error", "error": str(e), "code": "REVIEWS_ERROR"},
                status=status.HTTP_400_BAD_REQUEST,
            )
    ...
    def toggle_agent(self, request):
        ...
        try:
            ...
            return Response(
                {"status": "error", "error": str(e), "code": "TOGGLE_AGENT_ERROR"},
                status=status.HTTP_400_BAD_REQUEST,
            )
