      ...
      <div className="max-w-md w-full bg-white border border-gray-300 rounded-lg shadow-lg p-8 relative">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <button
              type="button"
              className="w-full py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center justify-center"
            >
